    ...
    public function run()
    {
        ...
        collect([
            [
                ...
                "city_id" => City::where('name', 'like', 'kabupaten badung')->select('id')->first()->id,
                "created_by" => $admin['id'],
            ...
            [
                ...
                "city_id" => City::where('name', 'like', 'KOTA YOGYAKARTA')->select('id')->first()->id,
                "price" => rand(100000, 1000000),
            ...
            [
                ...
                "city_id" => City::where('name', 'like', 'KABUPATEN LOMBOK UTARA')->select('id')->first()->id,
                "created_by" => $admin['id'],
                "price" => rand(100000, 1000000),
            ...
            [
                ...
                "city_id" => City::where('name', 'like', 'KABUPATEN BANDUNG')->select('id')->first()->id,
            ...
            [
                ...
                "province_id" => Province::where('name', 'like', 'NUSA TENGGARA TIMUR')->select('id')->first()->id,
                "created_by" => $admin['id'],
                "price" => rand(100000, 1000000),
                "category_id" => $nature,
            ],
            ...
            [
                ...
                "created_by" => $admin['id'],
                "province_id" => Province::where('name', 'like', 'Jawa Timur')->select('id')->first()->id,
                "city_id" => City::where('name', 'like', 'KABUPATEN PROBOLINGGO')->select('id')->first()->id,
                "price" => rand(100000, 1000000),
                "category_id" => $nature,
            ],
            [
